/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ813nMoebious = global.eonZ813nMoebious || {})))
  ...
  let z = function () {
    ...
    let conformLight = {
      'x': {
        ...
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': [[[60, 60]]], 'pa6': 0, 'pb7': -1,
        'dom3': [ 0, 180 ],
        'dom3': [ 0, [[[0, 360]]] ],
        c: [ 1, 1, 1, 1],
        'fn0': (e, c, d) => 1 + 0.5 * e[2] * cos(e[0] / 2) * cos(e[0]),
      },
      'y': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': [[[60, 60]]], 'pa6': 0, 'pb7': -1,
        'dom3': [ 0, [[[0, 360]]] ],
        c: [ 1, 1, 1, 1],
        'fn0': (e, c, d) => 1 + 0.5 * e[2] * cos(e[0] / 2) * sin(e[0]),
      },
      'z': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': [[[60, 60]]], 'pa6': 0, 'pb7': -1,
  ...
  exports.eonZ813nMoebious = anitem
}))