...
if (1 && 1) console.log("rotation begin", state.projection.rotate().map(d => d.toPrecision(2)))
      ...
      if (inve0 === undefined) if (1 && 2) console.error("inve0")
    ...
    let dragged = function () {
      let e = d3.event
if (1 && 1) console.log("rotation move a", state.projection.rotate().map(d => d.toPrecision(2))) 
      let proj = state.projection

      if (proj.invert === undefined
        || proj.rotate === undefined) if (1 && 2) console.error("invert")

      if (state.v0 === undefined || state.r0 === undefined) if (1 && 2) console.error("v0")
