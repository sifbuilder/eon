/* ******************************************
   *    @eonZ813iInsideSphere
   *
   */
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ813iInsideSphere = global.eonZ813iInsideSphere || {})))
        ...
        fn0: (e, c, d) => {
          ...
          // - 0.5 * cos(x) *  sin(z) * sin(z)
            ...
            1 * cos(z) * (
              +1 * cos(z) -
              1 * tan(z) * sin(z) +
              Math.sign(cos(x)) * 0.5 * Math.pow(Math.abs(cos(x)), 1) * cos(z) -
              Math.sign(cos(x)) * 0.5 * Math.pow(Math.abs(cos(x)), 1) * sin(z) * tan(z)
            )
  ...
  exports.eonZ813iInsideSphere = anitem
}))