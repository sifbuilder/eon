/* ******************************************
   *    @eonZ812sTorusOrigami
   *
   */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
    : typeof define === 'function' && define.amd ? define(['exports'], factory)
      : (factory((global.eonZ812sTorusOrigami = global.eonZ812sTorusOrigami || {})))
    ...
    // .................. pics
      ...
      let conformLight = {
        ...
        z: {
          ...
          c: [ 1, 1, 1, 5 ],
          fn0: (e, c, d) => {
            let r = Math.floor(d.c[1])
            return d.c[3] * c[0] * e[0] * c[3] * sin(e[0]) * cos(e[1])
          },
        },
  ...
  exports.eonZ812sTorusOrigami = anitem
}))
