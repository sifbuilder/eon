/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ812iTorusQuad = global.eonZ812iTorusQuad || {})))
  ...
  let z = function () {
    ...
    // ............................. pics
    let eotim = {'td': 3600, 't0': 0, 't1': 1, 't2': 1, 't3': 1, nostop: 1, tf: t => Math.pow(Math.sin(Math.PI * t / 2), 3)}
    ...
    let conformLight = {
      'x': {
        ...
        // e: [ cost, 1, 1, cosht ],
        c: [ 1, 1, [[[10, 10]]], [[[5, 5]]]],
        'fn0': (e, c, d) => c[0] * (d.c[2] + d.c[3] * cos(e[0])) * c[2] * cos(e[2]) * cos(e[3]) * sin(e[3]),
        // c: [ 5, 1, 1, 1],
        // e: [ cost , 1, 1,  cost  ]
      },
      'y': {
        ...
        'fn0': (e, c, d) => c[1] * (d.c[2] + d.c[3] * cos(e[0])) * c[2] * sin(e[2]) * cos(e[3]) * sin(e[3]),
      ...
      'z': {
        ...
        c: [ 1, 1, 1, [[[5, 5]]] ],
        'fn0': (e, c, d) => d.c[3] * sin(e[0]) * cos(e[2]),
      },
  ...
  exports.eonZ812iTorusQuad = anitem
}))