/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ811ePillows = global.eonZ811ePillows || {})))
    ...
    let conformRed = {
      ...
      'z': {
        ...
        e: [
          ...
          1,
          1,
          [infact0, infact1, infact2, infact3, infact4, infact5, infact6, infact7, infact8, infact9], // expt
        ],
      ...
      'r': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': 9, 'pa6': 0, 'pb7': -1,
        'dom3': [-90, 90],
        c: [], // [1, 1, [0,1], 1],
  ...
  exports.eonZ811ePillows = anitem
}))