/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ711aQuadric = global.eonZ711aQuadric || {})))
  ...
  let z = function () {
    ...
    let conform = {
      ...
      // "m1":1,"m2":1,"n1":0.5,"n2":0.5,"n3":0.5,"a":1,"b":1,  // drop
        ...
        // q * cos(v) => cos(q) * cos(v)
        c0: [1], e0: [0, 1], // 1 * q
        c3: [1], e3: [1, 0, -infact2, 0, +infact4, 0, -infact6, 0, infact8], // 1 * cos v
      ...
      z: {
        ...
        // q * sin(v) =>  sin(u)
        c0: [1], e0: [0, 1],
        c3: [1], e3: [0, +1, 0, -infact3, 0, +infact5, 0, -infact7, 0, infact9], // cos v
  ...
  exports.eonZ711aQuadric = anitem
}))
