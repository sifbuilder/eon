...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
    : typeof define === 'function' && define.amd ? define(['exports'], factory)
      : (factory((global.eonZ620fTrees = global.eonZ620fTrees || {})))
    ...
    // .................. pics
      ...
      let getNewFeature = function (feature, props, i) {
        let { growunit, baseangle,
          ...
          maxAngleDelta, directions, eocrom, shrinkage, colordelta,
        } = props
      ...
      let updFeature = function (feature, props, i) {
        let { subgrowunit, subdirections, subangfact, subShrinkage } = props
