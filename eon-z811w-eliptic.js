/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ811wEliptic = global.eonZ811wEliptic || {})))
  ...
  let z = function () {
    ...
    let conformLight = {
      'x': {
        ...
        'dom3': [-180, 180],
        // e: [ cost, 1, 1, cosht ],
        // 'fn0': (e,c) => Math.pow(e[0], 3) - 6 * e[0] + 2,
        c: [ 1, 1, 1, 1],
        e: [ [8, -5, 0, 1], 1, 1, 1 ],
      },
      'y': {
  ...
  exports.eonZ811wEliptic = anitem
}))