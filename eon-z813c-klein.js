...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
    : typeof define === 'function' && define.amd ? define(['exports'], factory)
      : (factory((global.eonZ813cKlein = global.eonZ813cKlein || {})))
  ...
  // .................. eons
    ...
    // .................. pics
      ...
      let conformLight = {
        ...
        'z': {
          'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
          'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0,
          'seg5': [[[0, 15, 60, 120, 120, 0, 0, 15, 15, 30, 120]]],
          'pa6': 0, 'pb7': -1,
          'dom3': [ 0, [[[0, 90, 180, 180, 180, 0, 15, 90, 180, 180]]] ],
          // 'dom3': [ 0, 180 ],
          c: [ 1,
            0,
      ...
      let lightAni = {
        ...
        eocrom: { 'csx': 0, 'cf': [[[ 666, 333, 666]]], 'co': [[[0.069, 0.06, 0.069]]],
          'cs': [[[333, 333, 555, 555]]], 'cw': [[[0.99, 0.9, 0.99]]], 'cp': [[[0.99, 0.99]]]},
        eoform: conformLight,
        eoload: {
        },
      }
