        ...
        for (let i = 0; i < Object.keys(count).length; i++) {
          ...
          if (count[key] > 0) { // if count on this sort
            ...
            //
              ...
              //
              //  generate the paced geoform from the genigram 
              ...
              // newItem inherit complement payload from genitem - conform, proform
              newItem.payload = Object.assign({}, newItem.payload, anigram.payload)

              // ///
              // check span between samples - disable with span:=0
              // //
