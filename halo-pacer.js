        ...
        for (let i = 0; i < Object.keys(count).length; i++) {
          ...
          if (count[key] > 0) { // if count on this sort
            ...
            // //
              ...
              // ///
              //  newItem subsidiarily inherits payload from genitem - conform, proform
              // //
              newItem.payload = Object.assign({}, newItem.payload, anigram.payload)
...
if (1 && 1) console.log("situs", situs)
              ...
              // //
                ...
                if (coords && coords.length > 0) {
                   ...
                   // last point in paced string
                  let presitus = coords[coords.length - 1]

                  // 2D, 3D
                  // the distance is measured in the geoform space
                  ...
                  // newItem.geofold.properties.geoformed.push(situs)
                  ...
                  // newItem.geofold.properties.geoformed = Array.of(situs)
