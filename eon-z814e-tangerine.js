/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ814eTangerine = global.eonZ814eTangerine || {})))
  ...
  let z = function () {
    ...
    let lightSphereAni = {
      ...
      eohal: eonEohalMars,
      eofold: p => eonMuonNatform.natMultiLineString({eoform: p.eoform, ghv: 1}), // hot geos
      eotim,
    ...
    let animas = [
      ...
      // sphereAni, // h.mars
      // lightSphereAni, // h.mars
      lightTangerineAni, // h.mars
      tangerineAni, // h.mars
  ...
  exports.eonZ814eTangerine = anitem
}))