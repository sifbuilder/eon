  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ813aKlein = global.eonZ813aKlein || {})))
      ...
      'x': {
        ...
        'fn0': (e, c, d) =>
          (-2 / d.c[2]) * cos(e[2]) * (
            ...
            5 * Math.pow(cos(e[2]), 1) * sin(e[2]) * cos(e[0])
          )
        ,
      },
      'y': {
        ...
        'fn0': (e, c, d) =>
          (-1 / d.c[2]) * sin(e[2]) * (
            3 * cos(e[0]) * Math.pow(cos(e[2]), 0) -
            3 * cos(e[0]) * Math.pow(cos(e[2]), 2) -
            48 * cos(e[0]) * Math.pow(cos(e[2]), 4) +
            48 * cos(e[0]) * Math.pow(cos(e[2]), 6) -
            60 * sin(e[2]) +
            5 * cos(e[0]) * sin(e[2]) * Math.pow(cos(e[2]), 1) -
            5 * cos(e[0]) * sin(e[2]) * Math.pow(cos(e[2]), 3) -
            80 * cos(e[0]) * sin(e[2]) * Math.pow(cos(e[2]), 5) +
            80 * cos(e[0]) * sin(e[2]) * Math.pow(cos(e[2]), 7)
          )
        ,
      },
      'z': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': [[[15, 15, 15, 30, 120]]], 'pa6': 0, 'pb7': -1,
        'dom3': [ [[[0, 0, 0]]], [[[0, 90, 180, 180, 180]]] ],
        c: [ 1, 1, [[[13, 17]]], 1 ],
        'fn0': (e, c, d) =>
          (2 / d.c[2]) * (
            3 +
              5 * cos(e[2]) * sin(e[2])) * sin(e[0]),
      },
      'r': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        // 'dom3': [ [[[0,0,-180]]], [[[0,180,180]]] ],
