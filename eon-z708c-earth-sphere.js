/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ708cEarthSphere = global.eonZ708cEarthSphere || {})))
  ...
  let z = function () {
    ...
    let graticubeAni = {
      ...
      eoframe: { extent: [ [-180, 180, 90, 90 ], [-90, 90, 45, 45] ] },
      eoload: {
      },
    ...
    let graticircAni = {
      ...
      eoframe: { geoframe: [ [-180, 180, 90, 90 ], [-90, 90, 45, 45] ] },
      eoload: {
      },
  ...
  exports.eonZ708cEarthSphere = anitem
}))