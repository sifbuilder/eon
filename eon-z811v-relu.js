  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ811vRelu = global.eonZ811vRelu || {})))
  ...
  let z = function () {
    ...
    let form = {
      'x': {
        ...
        'ra2': 20, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': 60, 'pa6': 0, 'pb7': -1,
        'dom3': [-180, 180],
    ...
    let conform = {
      'x': {
        ...
        // c: [ [0,1], 1, [0,1], 1],
        // e: [ cost, 1, 1, cosht ],
        'fn0': (e, c) => c[0] * cos(e[0]) * c[2] * Math.max(0, e[3]),
      },
      'y': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': 60, 'pa6': 0, 'pb7': -1,
        ...
        'fn0': (e, c, dax) => c[1] * sin(e[0]) * c[2] * Math.max(0, e[3]), // cos(e[3])
