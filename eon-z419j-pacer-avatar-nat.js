      ...
      eoload: {
        pacer: {
          ...
          eofold: function (ani, props) {
            let locus = muonStace.getLocus([null, null, null], ani)

            let point = {
              type: 'Feature',
              geometry: {
                type: 'Point',
                coordinates: muonStace.getLocus([null, null, null], ani),
              },
            }
            let form = muonNatform.natMultiLineString({eoform: ani.eoform})
            let eofold = muonGeoj.extrapol(form, point)
          ...
          eonode: function (ani, props) {
            ...
            if (props.key === 'init') { // INIT
              coords = muonStace.getLocus([null, null, null], ani)
