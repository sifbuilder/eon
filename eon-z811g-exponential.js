/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ811gExponential = global.eonZ811gExponential || {})))
  ...
  let z = function () {
    ...
    // ............................. pics
    let eotim = {'td': 18600, 't0': 0, 't1': 1, 't2': 1, 't3': 1, nostop: 0, tf: t => 1 - 4 * (t - 0.5) * (t - 0.5)}
    ...
    let conform = {
      x: {
        ...
        'dom3': [-180, 180],
        c: [1, 1, 1, 1],
        e: [ [0, 1], 1, 1, [infact0, 0, -infact2, 0, infact4, 0, -infact6, 0, infact8] ],
        // 'fn0': (e,c) => {
      ...
      y: {
        ...
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': 180, 'pa6': 0, 'pb7': -1,
        'dom3': [-180, 180],
        'fn0': (e, c) => (1 / Math.exp(Math.abs(e[1] / 2))) * cos(9 * e[1]), // net
      ...
      z: {
        ...
        'dom3': [-90, 90],
        // c: [ [0, 1], [1], [1], [0, 1] ],
        // e: [ [0, 1], [1], [1], [0, infact1, 0, -infact3, 0, infact5, 0, -infact7, 0, infact9] ],
        fn0: (e, c) => {
    ...
    let eocrom = { 'csx': 0, 'cf': [[[266, 266, 266]]], 'co': [[[0.5, 0.5]]],
    ...
    let natAni = {
      ...
      eomot: {
        proform: {
          ...
          translate: [ [0, 0, 0] ],
          rotate: [ [[[-80, -100, -80, -100, -80, -100, -80, -100, -80, -100, -80]]], 6, 0 ],
  ...
  exports.eonZ811gExponential = anitem
}))