...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
    : typeof define === 'function' && define.amd ? define(['exports'], factory)
      : (factory((global.eonZ710fDropfn = global.eonZ710fDropfn || {})))
    ...
    // .................. pics
      ...
      let conform = {
        x: {
          ...
          'fn0': (e, c, d) => a * cos(q) * c * cos(v),
          'fn0': (e, c, d) => a * cos(q),
          'fn0': (e, c, d) => sqrt(a * sin(q)) * cos(v),
          'fn0': (e, c, d) => (1 - sin(e[0])),
        ...
        y: {
          ...
          'fn0': (e, c, d) => (1 - sin(e[0])) * cos(e[0]) * cos(e[2]), // f(u) cos(v)
        ...
        // "m1":1,"m2":1,"n1":0.5,"n2":0.5,"n3":0.5,"a":1,"b":1,  // drop
          ...
          'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': 12, 'pa6': 0, 'pb7': -1,
          'dom3': [-180, 180],
          'fn0': (e, c, d) => (1 - sin(e[0])) * cos(e[0]) * sin(e[2]), // f(u) sin(v)
        },
