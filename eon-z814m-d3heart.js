...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
    : typeof define === 'function' && define.amd ? define(['exports'], factory)
      : (factory((global.eonZ814mD3heart = global.eonZ814mD3heart || {})))
  ...
  // .................. eons
    ...
    let z = function () {
    // .................. pics
      let eotim = {'td': 12800, 't0': 0, 't1': 1, 't2': 1, 't3': 1, nostop: 1}

      let pi = Math.PI, pih = Math.PI / 2,
        radians = Math.PI / 180, degrees = 180 / Math.PI,
        sin = Math.sin, cos = Math.cos, atan2 = Math.atan2, acos = Math.acos, asin = Math.asin,
        sqrt = Math.sqrt,
      ...
      let conform = {
        x: {
          ...
          c: [ [[[0, 1, 1, 1]]], [[[0, 0, 0.6, 0.6]]], 1, 1 ],
          'fn0': (e, c, d) => cos(e[0]) * cos(e[0]), // parabole
          'fn0': (e, c, d) => cos(e[0]) * sin(e[0]), // loop
          // 'fn0': (e, c, d) => cos(e[0])* cos(e[2]) * (1 - d.c[1] * sin(e[0])),
          // 'fn0': (e, c, d) => cos(e[0])* cos(e[2]) * (1 - d.c[0] * sin(e[0]))* (1 - d.c[1] * sin(e[0]+pi)) ,
          fn0: (e, c, d) => cos(e[0]) * (1 - sin(e[0])) * cos(e[2]),
          fn0: (e, c, d) => cos(e[0]) * (1 - d.c[0] * cos(e[0] + pih)) * (1 - d.c[1] * sin(e[0])),
          fn0: (e, c, d) => cos(e[0] + pi) * (1 - d.c[0] * cos(e[0] + pih)) * (1 - d.c[1] * sin(e[0])) * cos(e[2]),
        ...
        y: {
          ...
          fn0: (e, c, d) => sin(e[0] + pi) * cos(e[2]),
          fn0: (e, c, d) => sin(e[0] + pi) * (1 - d.c[0] * cos(e[0] + pih)),
        ...
        // "m1":1,"m2":1,"n1":0.5,"n2":0.5,"n3":0.5,"a":1,"b":1,  // drop
          ...
          fn0: (e, c, d) => cos(e[0] + pi) * (1 - d.c[0] * cos(e[0] + pih)) * (1 - d.c[1] * sin(e[0])), // * sin(e[2]),
        },
      ...
      let natAniB = {
        ...
        eofold: ani => {
          let tim = ani.eoload.tim
          let res

          // if (tim < 0.8) {
          // res = eonMuonNatform.natMultiLineString({eoform: ani.eoform, ghv: 1})
          // } else {
          res = eonMuonNatform.natMultiPolygon({eoform: ani.eoform, ghv: 1})
          // }
          return res
        },
        eomot: {
  ...
  exports.eonZ814mD3heart = anitem
}))
