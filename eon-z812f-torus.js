/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ812fTorus = global.eonZ812fTorus || {})))
  ...
  let z = function () {
    ...
    // ............................. pics
    let eotim = {'td': 18600, 't0': 0, 't1': 1, 't2': 1, 't3': 1, nostop: 1 }

    let conformLight = {
      'x': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': [[[18, 64, 64]]], 'pa6': 0, 'pb7': -1,
        'dom3': [-180, 180],
        // e: [ cost, 1, 1, cosht ],
        c: [ 1, 1, [[[10, 7, 5, 7, 7]]], [[[5, 5]]]],
      ...
      'z': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        'ra2': 120, 'v0': 0, 'v1': 1, 'w4': 0, 'seg5': [[[18, 64, 64]]], 'pa6': 0, 'pb7': -1,
        'dom3': [ [[[0, -180, -180]]], [[[0, 180, 180]]] ],
        // c: [1, 1, 1, [0,1]],
        // e: [ 1, 1, sint, 1 ], // 1 * sin(v)
        c: [ 1, 1, 1, [[[5, 5]]] ],
        'fn0': (e, c, d) => d.c[3] * c[3] * sin(e[0]) * cos(e[1]),
      },
