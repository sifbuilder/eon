...
api.d00 = (p = { opt: 'help' }) => {
  if (p.opt === 'help') {
    ...
    console.log(
      'in http://www.netlifycms.org get the gatsby cms  https://app.netlify.com/start/deploy?repository=https://github.com/AustinGreen/gatsby-starter-netlify-cms&stack=cms'
    )
...
api.d6 = (p = { opt: 'help' }) => {
  ...
  if (p.opt === 'help') {
    ...
    if (fs.existsSync(filelog['toFile06'])) {
      ...
      if (!fs.existsSync(filelog['toFile06_bck']))
...
api.d07 = (p = { opt: 'help' }) => {
  ...
  if (p.opt === 'help') {
    ...
    if (fs.existsSync(filelog['toFile07'])) {
      ...
      if (!fs.existsSync(filelog['toFile07_bck']))
...
api.d08 = (p = { opt: 'help' }) => {
  ...
  if (p.opt === 'help') {
    ...
    if (fs.existsSync(filelog['toFile08'])) {
      ...
      if (!fs.existsSync(filelog['toFile08_bck']))
...
api.d09 = (p = { opt: 'help' }) => {
  ...
  if (p.opt === 'help') {
    ...
    if (fs.existsSync(filelog['toFile09'])) {
      ...
      if (!fs.existsSync(filelog['toFile09_bck']))
...
api.d10 = (p = { opt: 'help' }) => {
  ...
  if (p.opt === 'help') {
    ...
    if (fs.existsSync(filelog['toFile10'])) {
      ...
      if (!fs.existsSync(filelog['toFile10_bck']))
...
api.d13 = (opt = 'help') => {
  ...
  if (fs.existsSync(filelog['toFile13'])) {
    ...
    if (!fs.existsSync(filelog['toFile13_bck']))
      fs.copyFileSync(filelog['toFile13'], filelog['toFile13_bck'])
...
api.d14 = (opt = 'help') => {
  ...
  if (fs.existsSync(filelog['toFile14'])) {
    ...
    if (!fs.existsSync(filelog['toFile14_bck']))
...
api.d15 = (opt = 'help') => {
  ...
  if (fs.existsSync(filelog['toFile15'])) {
    ...
    if (!fs.existsSync(filelog['toFile15_bck']))
      fs.copyFileSync(filelog['toFile15'], filelog['toFile15_bck'])
...
api.d18 = (opt = 'help') => {
  ...
  if (fs.existsSync(filelog['toFile18'])) {
    ...
    if (!fs.existsSync(filelog['toFile18_bck']))
      fs.copyFileSync(filelog['toFile18'], filelog['toFile18_bck'])
