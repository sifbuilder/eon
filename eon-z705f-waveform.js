/* ******************************************
  ...
  (function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports)
      : typeof define === 'function' && define.amd ? define(['exports'], factory)
        : (factory((global.eonZ705fWaveform = global.eonZ705fWaveform || {})))
  ...
  let z = function () {
    ...
    let stace = {
      'x': {
        'm1': 4, 'm2': 4, 'n1': 2, 'n2': 2, 'n3': 2, 'a': 1, 'b': 1, // circ
        'ra2': 180, 'v0': 0, 'v1': 1, 'seg5': 12, 'w4': 0, 'pa6': 0, 'pb7': -1,
        'dom3': [-180, 180],
        'fn0': (e, c, d) => c[0] * cos(e[0]) * c[2] * cos(e[2]),
      },
      'y': {
    ...
    const waveProform = {
      ...
      translate: [0, 0, 0],
      scale: 1,
      rotate: [ 90, [[[0, 6, -6, 6, -6, 6]]], [[[0, 160 * 360]]] ], // dyn
      lens: [ 0, 1, Infinity ],
    }
    const waveProform2 = {
      projection: 'uniwen',
  ...
  exports.eonZ705fWaveform = anitem
}))